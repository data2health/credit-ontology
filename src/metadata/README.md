 ...
 * [credit.yml](credit.yml)
     * Determines how your purl.obolibrary.org/obo/credit/ redirects will be handled
     ...
     * Paste in the contents of [credit.yml](credit.yml)
 ...
 * [credit.md](credit.md)
     ...
     * Paste in the contents of [credit.md](credit.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
